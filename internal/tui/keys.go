...
func DefaultKeymap() Keymap {
	return Keymap{
		...
		PriorityCycleDown: key.NewBinding(key.WithKeys("P"), key.WithHelp("P", "priority (down)")),
		...
		YankAll:           key.NewBinding(key.WithKeys("Y"), key.WithHelp("Y", "yank ALL visible tasks as text")),
	}
}
